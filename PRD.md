...
<div on:scroll={onScroll} style="overflow-y: auto; height: {containerHeight}px;">
...
- This is a simplified _fixed height_ approach. For dynamic heights, you’d measure each item’s rendered height (perhaps via a Svelte action or an IntersectionObserver), and update your offset calculations as needed.
